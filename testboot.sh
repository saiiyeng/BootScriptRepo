...
OStype=`uname -m`
echo "Checking for 64 bit version of OS....$OStype" >> $MYLOGFILE

Java_version=`/opt/ParaBlu/jre/bin/java -version`
echo "Checking Java version...$Java_version" >> $MYLOGFILE

### TODO: yet to learn the parameters needed for run.sh
