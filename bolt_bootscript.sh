...
sudo wget http://files.trendmicro.com/products/deepsecurity/en/9.6/Agent-RedHat_EL7-9.6.2-7723.x86_64.zip -P /tmp/Installer
sudo unzip /tmp/Installer/Agent-RedHat_EL7-9.6.2-7723.x86_64.zip -d /tmp/Installer
